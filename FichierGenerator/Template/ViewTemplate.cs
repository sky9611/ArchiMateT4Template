...
namespace FichierGenerator.Template
{
    ...
    #line 1 "D:\documents\INSA\maidis\vs\Projet\FichierGenerator\FichierGenerator\Template\ViewTemplate.tt"
...
/// <summary>
/// Access the groupName parameter of the template.
/// </summary>
...
public virtual void Initialize()
{
    ...
    {
bool groupNameValueAcquired = false;
if (this.Session.ContainsKey("groupName"))
{
    this._groupNameField = ((string)(this.Session["groupName"]));
    groupNameValueAcquired = true;
}
if ((groupNameValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("groupName");
    if ((data != null))
    {
        this._groupNameField = ((string)(data));
    }
}
