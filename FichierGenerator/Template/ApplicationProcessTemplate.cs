...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 20 "D:\documents\INSA\maidis\vs\Projet\FichierGenerator\FichierGenerator\Template\ApplicationProcessTemplate.tt"
	...
	if(mmap_group_access.TryGetValue(id_group, out list_using))
	{
		foreach(var id in list_using)
		{
            ...
            #line 107 "D:\documents\INSA\maidis\vs\Projet\FichierGenerator\FichierGenerator\Template\ApplicationProcessTemplate.tt"
	...
	if( mmap_association.ContainsKey(id_element))
	{
		foreach(var id_associated in mmap_association[id_element])
		{
            ...
            #line 161 "D:\documents\INSA\maidis\vs\Projet\FichierGenerator\FichierGenerator\Template\ApplicationProcessTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(element_associated.Type_));
	...
	if (!mmap_specialization.Keys.Contains(id_element))
	{
            ...
            #line 173 "D:\documents\INSA\maidis\vs\Projet\FichierGenerator\FichierGenerator\Template\ApplicationProcessTemplate.tt"
	...
	if (mmap_relationship.ContainsKey(id_element))
	{
		...
		if (mmap_relationship[id_element]["source"].TryGetValue("Access", out list_associated))
		{
            ...
            #line 211 "D:\documents\INSA\maidis\vs\Projet\FichierGenerator\FichierGenerator\Template\ApplicationProcessTemplate.tt"
		...
		if (mmap_relationship[id_element]["source"].TryGetValue("Flow", out list_flow))
		{
            ...
            #line 233 "D:\documents\INSA\maidis\vs\Projet\FichierGenerator\FichierGenerator\Template\ApplicationProcessTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(UpperString(element_associated.Class_name_)));
        ...
        #line 244 "D:\documents\INSA\maidis\vs\Projet\FichierGenerator\FichierGenerator\Template\ApplicationProcessTemplate.tt"
